...
if($count>0)
{
echo "<span style='color:red'> ID number already exist. Please try again .</span>";
}
...
$stmt->close();
if($count>0)
echo "<span style='color:red'>$count Gym Space already full.</span>";
else
	echo "<span style='color:red'>All Gym Space are Available</span>";
}
?>