...
?>
                                                    ...
                                                    <div claess="stat-panel-title text-uppercase"> Members</div>
                                                </div>
                                            </div>
...
?>
                                                    ...
                                                    <div class="stat-panel-title text-uppercase">Total Package Type
                                                    </div>
                                                </div>
                                            </div>
...
?>
                                                            ...
                                                            <div class="stat-panel-number h1 "><?php echo $count;?>
                                                            </div>
                                                            <div class="stat-panel-title text-uppercase"> Registered
                                                                Complaints</div>
                                                        </div>
                                                    </div>
                                                    <a href="all-complaints.php" class="block-anchor panel-footer">Full
...
$stmt1->close();
?>
                                                            <div class="stat-panel-number h1 "><?php echo $count1;?>
                                                            </div>
                                                            <div class="stat-panel-title text-uppercase">New Complaints
                                                            </div>
                                                        </div>
                                                    </div>
...
$stmt2->close();
?>
                                                            <div class="stat-panel-number h1 "><?php echo $count2;?>
                                                            </div>
                                                            <div class="stat-panel-title text-uppercase">In Process
                                                                Complaints</div>
                                                        </div>
                                                    </div>
                                                    <a href="inprocess-complaints.php"
                                                        class="block-anchor panel-footer text-center">See All &nbsp; <i
                                                            class="fa fa-arrow-right"></i></a>
                                                </div>
                                            </div>
...
?>
                                                            ...
                                                            <div class="stat-panel-title text-uppercase">Closed
                                                                Complaints </div>
                                                        </div>
                                                    </div>
...
?>
                                                            ...
                                                            <div class="stat-panel-title text-uppercase">Total Feedbacks
                                                            </div>
                                                        </div>
                                                    </div>
