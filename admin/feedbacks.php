    ...
    <div class="ts-main-content">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title" style="margin-top:4%">Member Feedback</h2>
...
while($row=$res->fetch_object())
	  {
	  	?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="feedback-details.php?regno=<?php echo $row->regno;?>&&uid=<?php echo $row->userId;?>"
                                                    title="View Full Details" target="blank"><i
