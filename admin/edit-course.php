            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Edit Package Type </h2>
	   ...
	   while($row=$res->fetch_object())
	  {
	  	?>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Package Type Code </label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Package Type Name (Short)</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Package Type Name(Full)</label>
                                                <div class="col-sm-8">
