...
$stmt->execute();
echo"<script>alert('Member Succssfully register');</script>";
}
?>
...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
                                            <h3 style="color: red" align="center">Gym already booked by you</h3>
                                            <div align="center">
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-body bk-success text-light">
                                                            <div class="stat-panel text-center">
                                                                ...
                                                                <div class="stat-panel-number h1 ">My Category</div>
							...
							?>
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">
                                                    <h4 style="color: green" align="left">Category Related info </h4>
                                                </label>
                                            </div>
	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Personal Assistant Name : </label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Personal Assistant Relation :
                                                </label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Personal Assistant Contact no :
                                                </label>
                                                <div class="col-sm-8">
