...
while($row=$res->fetch_object())
	  { ?>
                                        ...
                                        <table id="zctb" class="table table-bordered " cellspacing="0" width="100%"
                                            ...
                                            <tr>
                                                <th>Accessibility to Gym Committee members </th>
                                            ...
                                            <tr>
                                                <th>Gym Surroundings (eg Lawn,Weights etc.) </th>
	...
	?>
                                        <form method="post" action="" name="complaint" class="form-horizontal"
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Accessibility to Gym
                                                    Equipment</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Accessibility to Gym Committee
                                                    members</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input type="radio" name="Room" value="Below Average" required>Below
                                                    Average
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input type="radio" name="Mess" value="Below Average" required>Below
                                                    Average
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Gym Surroundings (eg Lawn,Weights
                                                    etc.)
                                                </label>
                                                <div class="col-sm-8">
                                                    <input type="radio" name="hstelsor" value="Excellent"
                                                        required>Excellent
                                                    <input type="radio" name="hstelsor" value="Very Good" required>Very
                                                    Good
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="radio" name="overall" value="Excellent"
                                                        required>Excellent
                                                    <input type="radio" name="overall" value="Very Good" required>Very
                                                    Good
                                        ...
                                        <?php }} else {?>
                                        <div>You are not eligible for Feedback. Once you book the Gym Sessions, you will
                                            be
                                            eligible for feedback.</div>
                                        <?php }?>
                                    </div>
                                </div>
                            </div>
