        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row" id="print">
                    ...
                    <div class="col-md-12">
                        <h2 class="page-title" style="margin-top:3%">CategoryDetails</h2>
...
echo $ff=0;
echo "<span style='padding-left:2%; color:red;'>(You booked Gym without food).<span>";
}?></td>
                                        </tr>
                                        <tr>
                                            <th>Total Fee :</th>
                                        ...
                                        <tr>
                                            ...
                                            <td><b>Personal Assistant Name :</b></td>
                                            <td><?php echo $row->guardianName;?></td>
                                            <td><b>Personal Assistant Relation :</b></td>
                                            <td><?php echo $row->guardianRelation;?></td>
                                        </tr>

                                        <tr>
                                            <td><b>Personal Assistant Contact No. :</b></td>
